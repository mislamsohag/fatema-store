...
<div class="container-fluid">
    <div class="row">
            ...
            <div class="shadow-sm h-100 bg-white rounded-3 p-3">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <p class="text-bold text-xs my-1 text-dark"> VAT(7.5%): <i class="bi bi-currency-dollar"></i>
                            <span id="vat"></span></p>
        ...
        <!-- Products table for create invoice -->
        <div class="col-md-4 col-lg-4 p-2">
            <div class="shadow-sm h-100 bg-white rounded-3 p-3">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-12 p-1">
                                <label class="form-label d-none">Product ID <span class="text-danger">*</span></label>
                                <input type="text" class="form-control d-none" id="PId">
                                <label class="form-label mt-2">Product Name <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="PName">
                                <label class="form-label mt-2">Product Price <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="PPrice">
                                <label class="form-label mt-2">Product Qty <span class="text-danger">*</span></label>
...
<script>
    ...
    // Customer List Table Show for Adding
    ...
    async function createInvoice() {
        ...
        if (CId.length === 0) {
            ...
            showLoader();
            let res = await axios.post("/invoice-store", Data)
            hideLoader();
            if (res.data === 1) {
